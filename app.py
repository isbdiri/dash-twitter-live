                ...
                html.Div(
                    [
                        html.A(
                            ...
                            href='https://diri.isb.edu',
                            target='_blank',
                            className="app__header__title"
                        ),
                        html.P(
                            "This app streams tweets about Aadhaar in real time and displays live charts and sentiment analysis.",
                ...
                html.Div(
                    [   
                        ...
                        html.Div(
                                    [
                                        html.P(
                                            "Total number of tweets streamed during last 3 hours: 0",
                                            id="bin-size",
                                            className="auto__p",
                                        ),
                                    ],
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.P(
                            "The app streams Aadhaar-related tweets for the last 3 hours; refreshes every minute.",
...
def show_num_bins(slider_value):
    ...
    return "Total number of tweets streamed during last 3 hours: " + str(int(total_tweets))
